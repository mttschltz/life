      ...
      fetchedChildren = [
        {
          ...
          slug: 'fetched child1 slug',
          previousSlugs: ['fetched child1 prev', 'fetched child1 ious'],
        ...
        },
        {
          ...
          slug: 'fetched child2 slug',
          previousSlugs: ['fetched child2 prev', 'fetched child2 ious'],
