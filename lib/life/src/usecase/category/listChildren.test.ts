      ...
      listedChildren = [
        {
          ...
          path: '/listed child1 path',
          previousPaths: ['/listed child1 path1', '/listed child1 path2'],
        ...
        },
        {
          ...
          path: '/listed child2 path',
          previousPaths: ['/listed child2 path1', '/listed child2 path2'],
