...
type Risk = Node & {
  ...
  readonly children: ReadonlyArray<Node>;
  readonly internal: Internal;
  readonly uriPart: Maybe<Scalars['String']>;
  readonly name: Maybe<Scalars['String']>;
};
...
type Store_Risk = Store_Updated & {
  /** The id. */
  readonly id: Scalars['ID'];
  /** Risk category. */
  readonly category: Store_CategoryTopLevel;
  /** The impact. */
  readonly impact: Store_Impact;
  /** The likelihood. */
  readonly likelihood: Store_Likelihood;
  /** The name. */
  readonly name: Scalars['String'];
  /** Risk notes. */
...
type Store = {
  ...
  readonly updated: ReadonlyArray<Maybe<Store_Updated>>;
};
...
type Query = {
  ...
  readonly risk: Maybe<Risk>;
  readonly allRisk: RiskConnection;
...
type Query_riskArgs = {
  ...
  children: Maybe<NodeFilterListInput>;
  internal: Maybe<InternalFilterInput>;
  uriPart: Maybe<StringQueryOperatorInput>;
  name: Maybe<StringQueryOperatorInput>;
};


type Query_allRiskArgs = {
  filter: Maybe<RiskFilterInput>;
  sort: Maybe<RiskSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
...
type RiskConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<RiskEdge>;
  readonly nodes: ReadonlyArray<Risk>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<RiskGroupConnection>;
};


type RiskConnection_distinctArgs = {
  field: RiskFieldsEnum;
};


type RiskConnection_maxArgs = {
  field: RiskFieldsEnum;
};


type RiskConnection_minArgs = {
  field: RiskFieldsEnum;
};


type RiskConnection_sumArgs = {
  field: RiskFieldsEnum;
};


type RiskConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: RiskFieldsEnum;
};
...
type RiskEdge = {
  readonly next: Maybe<Risk>;
  readonly node: Risk;
  readonly previous: Maybe<Risk>;
};
...
type RiskFilterInput = {
  ...
  readonly children: Maybe<NodeFilterListInput>;
  readonly internal: Maybe<InternalFilterInput>;
  readonly uriPart: Maybe<StringQueryOperatorInput>;
  readonly name: Maybe<StringQueryOperatorInput>;
};

type RiskSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<RiskFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
